...
hl.animation({ leaf = "windows",             enabled = true, speed = 0.5, spring = "easy",  style = "slide" })
hl.animation({ leaf = "workspaces",          enabled = true, speed = 0.5, bezier = "quick", style = "slide 20%" })
